      <div class="large-box">
        ...
        <input type="text" value="Start typing a quiz name" name="quiz_name" id="quiz_name" class="large" onkeypress="part1_title_check()" onclick="part1_title_check()">
      ...
      <div class="large-box">
        ...
        <p class="line2">Creating a description helps users find your quiz and gets them more interested in taking it.
          <textarea name="quiz_description" id="quiz_description" class="short_textarea" rows="1" cols="1" onclick="part1_description_check();" onkeypress="part1_description_check();">Example: This quiz will show you if you are a real celebrity fashionista! Find out now!</textarea>
        </p>
        <div id="quiz_description_note" class="chars">600 characters left.</div>
      </div>
      
      <div class="g_continue">
        <a onclick="show_part2()">
