        ...
        <div class="dialog_content">
          <div class="dialog_body">
            <div class="fb_protected_wrapper" fb_protected="true">
              <div>
                <?php render('block/question_image_form.php',array('q'=>$q)); ?>
              </div>
            </div>
          </div>
          <div class="dialog_buttons clearfix">
            <label class="uiButton uiButtonLarge uiButtonConfirm">
            <input type="button" name="button1" value="Save" onclick="question_save_image(<?php echo $q; ?>)">
            </label>
            <label class="uiButton uiButtonLarge uiButtonConfirm">
            <input type="button" name="button2" value="Cancel" onclick="question_hide_image_upload(<?php echo $q; ?>)">
            </label>
          </div>
        </div>
      </div>
